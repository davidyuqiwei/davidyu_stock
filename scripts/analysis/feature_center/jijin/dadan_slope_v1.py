...
df1 = pd.read_csv("/home/davidyu/stock/data/tmp_data/feature_center/jijin_data.csv",header=None)
df1.columns = ["stock_index","dadan_date","stock_name","vol"]
stat_days = 0
#pred_days = 30
pred_days_list = [30,60,90]
