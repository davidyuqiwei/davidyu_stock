...
select_date = '2019-12-01'
df1 = get_all_date()
df2 = df1[df1['stock_date']>= select_date]
...
df3['stock_index'].to_csv(os.path.join(save_dir,"stock_index_list.csv"),index=0,header=None)
os.system("sh /home/davidyu/stock/scripts/davidyu_stock/scripts/download/day_history_wangyi/run_download_day_history_wangyi.sh")
