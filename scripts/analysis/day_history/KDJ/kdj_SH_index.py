...
dataframe_list = []
feature_list = ['kdjk','kdjd','kdjj','macdh',"rsi_6","wr_6","wr_10","wr_20","rsi_12","rsi_24","close"]
window = 5
...
df_merge = pd.merge(df_feature,df_roll_reg[["stock_date"]+cols_to_use.tolist()],on=("stock_date"))
