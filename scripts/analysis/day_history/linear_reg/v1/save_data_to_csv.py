...
def saveSparkSelectDataToCsv(stock_index,start_date,end_date,columns_in,save_path,file_name):
    ...
    #log.info("input stock index".format(str(stock_index)))
    log.error("====================input stock index")
    print('saveSparkSelect')
    '''
...
if __name__ == "__main__":
    ...
    spark-submit save_data_to_csv.py 'adj_close' "('300760', '300294')" '2020-01-02' '2020-12-12' --file_name 'test.csv'
    ...
    print("input stock index"+stock_index)
