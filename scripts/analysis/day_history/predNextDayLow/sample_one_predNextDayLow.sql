drop table stock_test.sample_predNextDayLow_601398;
create table stock_test.sample_predNextDayLow_601398 as 
...
where b.stock_date is not null and a.stock_index='601398'
order by rand()
limit 200000
;
