...
class modelling:
    ...
    def xgboost(self,**kwargs):
        ...
        logging.info('feature importance - {}'.format(feature_import.sort_values("score", ascending=False).to_json()))
    ...
    def train_cut_score(b2,quant_set=1):
        ...
        logging.info("threshold: " + str(np.round(thres, 3)))
        return thres
    ...
    def test_score(bst, y_test, dtest, thres,model_type=1):
        ...
        logging.info("pred postive ratio: " + str(np.round(pos_ratio, 3)))
        return df_pred_raw
