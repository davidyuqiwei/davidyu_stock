...
def makeHistoryPriceDF(raw_file,history_days,raw_data_name):
    ...
    save_dir = os.path.join(feature_dir,"historyPrice")
    ...
    df_feature.to_csv(os.path.join(save_dir,file_name))
    return insert_colnames
...
for i in range(0,20):
    ...
    history_days = 60
    insert_colnames = makeHistoryPriceDF(raw_file,history_days,raw_data_name)
