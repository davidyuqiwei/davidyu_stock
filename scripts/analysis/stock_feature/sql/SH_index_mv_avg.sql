...
SELECT stock_date,adj_close,high,low,volume,
...
round(avg(volume) OVER (ORDER BY stock_date ROWS BETWEEN 5 PRECEDING AND 1 PRECEDING),2) AS volume_mv_avg5,
round(avg(volume) OVER (ORDER BY stock_date ROWS BETWEEN 10 PRECEDING AND 1 PRECEDING),2) AS volume_mv_avg10,
round(avg(volume) OVER (ORDER BY stock_date ROWS BETWEEN 15 PRECEDING AND 1 PRECEDING),2) AS volume_mv_avg15,
round(avg(volume) OVER (ORDER BY stock_date ROWS BETWEEN 20 PRECEDING AND 1 PRECEDING),2) AS volume_mv_avg20,
round(avg(volume) OVER (ORDER BY stock_date ROWS BETWEEN 30 PRECEDING AND 1 PRECEDING),2) AS volume_mv_avg30,
round(avg(volume) OVER (ORDER BY stock_date ROWS BETWEEN 40 PRECEDING AND 1 PRECEDING),2) AS volume_mv_avg40,
round(avg(volume) OVER (ORDER BY stock_date ROWS BETWEEN 50 PRECEDING AND 1 PRECEDING),2) AS volume_mv_avg50,
round(avg(volume) OVER (ORDER BY stock_date ROWS BETWEEN 60 PRECEDING AND 1 PRECEDING),2) AS volume_mv_avg60,
round(avg(volume) OVER (ORDER BY stock_date ROWS BETWEEN 120 PRECEDING AND 1 PRECEDING),2) AS volume_mv_avg120,
round(avg(volume) OVER (ORDER BY stock_date ROWS BETWEEN 150 PRECEDING AND 1 PRECEDING),2) AS volume_mv_avg150,
round(avg(volume) OVER (ORDER BY stock_date ROWS BETWEEN 200 PRECEDING AND 1 PRECEDING),2) AS volume_mv_avg200,
round(avg(volume) OVER (ORDER BY stock_date ROWS BETWEEN 300 PRECEDING AND 1 PRECEDING),2) AS volume_mv_avg300
