...
#sql1= """ select x1,round(x3,3) as adj_close,
#    x94 as stock_index from %s where
#     x94='601398' order by x1 """ %(source_table)
...
'''
variable='x2'
df3 = make_the_DF(start_date,variable)
...
for i in range(2,20):
    try:
	    ...
	    sql2="""select table1.*,table2.adj_close as %s,table2.cnt as %s 
