...
def baoStockSlope(stock_index,start_date,stat_days,pred_days):
    df_dir = tmp_data_dict.get("baostock")
    df_dir = os.path.join(data_path,"history_data","baostock")
    try:
        ...
        print("{},{},{},{},{}".format(stock_index,pred_start_date,pred_end_date,pred_days,-999))

if __name__ =='__main__':
    stock_index = sys.argv[1]
    start_date = sys.argv[2]
    stat_days = sys.argv[3]
    pred_days = int(sys.argv[4])
    baoStockSlope(stock_index,start_date,stat_days,pred_days)
