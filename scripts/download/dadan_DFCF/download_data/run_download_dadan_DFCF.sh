...
file1="dadan_DFCF_"$download_date".txt"
raw_data_dir=$stock_data"/raw_data"
save_data_dir=$stock_data"/dadan_DFCF"
out_data_name=$download_date".csv"
...
python download_dadan_DFCF.py $out_data_name
mv $out_data_name $save_data_dir
rm -rf $file1
