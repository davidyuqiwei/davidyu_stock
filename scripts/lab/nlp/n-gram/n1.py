# -*- coding: utf-8 -*-
#https://www.jianshu.com/p/ffb9dce5786a
...
def cleanText(input):
    ...
    input = bytes(input,encoding = 'utf-8') # 把内容转换成utf-8格式以消除转义字符
...
import urllib
#方法一：对网页直接进行读取
content = urllib.request.urlopen(urllib.request.Request("http://pythonscraping.com/files/inaugurationSpeech.txt")).read()
