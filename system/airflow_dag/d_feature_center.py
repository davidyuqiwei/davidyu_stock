...
with DAG(dag_id="d_feature_center", start_date=days_ago(2), schedule_interval="@yearly") as dag:
    ...
    ### 1
    a_feature_center = BranchPythonOperator(task_id="a_feature_center",python_callable=lambda: "true_2")
    ...
    a_feature_center >> data_dfcf_fuquan >> t_rolling_regression
    data_dfcf_fuquan >> t_macd
    '''
