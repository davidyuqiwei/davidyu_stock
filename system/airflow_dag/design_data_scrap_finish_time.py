...
"""
dfcf_fuquan          |    p0    | 19:35   | need loop  | 
dadan_realtime_ifeng |    p0    | 21:00   | need loop  |


vol_price_distr      |    p1    | 06:00   | need loop
all_owner            |    p1    | 23:00   | no loop    |


dadan_dfcf     :          17:38   | need loop 
dazongjiaoyi   :          19:40
...
"""
with DAG(dag_id="design_data_scrap_finish_time", start_date=days_ago(2), schedule_interval="@yearly") as dag:
